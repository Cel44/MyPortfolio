      ...
      <>
         <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-6 py-4 z-50 transition-transform duration-300 ${visible ? 'translate-y-0' : '-translate-y-full'}`}>
            ...
            <div className='hidden lg:block'>
               <a href= "#contact"
                  className='bg-linear-to-r from-sky-300 to-indigo-800 text-white px-5 py-2 rounded-full font-medium shadow-lg hover:opacity-90 transition-opacity duration-300'
               >
                  Contact me
               </a>
